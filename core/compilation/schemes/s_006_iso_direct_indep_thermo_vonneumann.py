"""
006. Iso-Direct-Indep + Thermo-Entropy-vonNeumann
Classification: S = Iso-Direct-Independent   T = T.3.1.1 (von Neumann entropy gradient)
"""
...
class IsoDirectIndepThermoVonNeumann(CompilationScheme):

    @property
    def scheme_id(self) -> str:
        return "iso_direct_indep_thermo_vonneumann"

    @property
    def description(self) -> str:
        return "Iso-Direct-Indep + Thermo-Entropy-vonNeumann"
